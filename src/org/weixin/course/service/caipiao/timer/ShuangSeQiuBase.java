 ...
 * 
 */
public class ShuangSeQiuBase {

	private List<ShuangSeQiuBean> dataList = new ArrayList<ShuangSeQiuBean>();
//	private final String url = "http://datachart.500.com/ssq/history/history.shtml";
	...
	private void makeXmlData() {
		...
		String[] tempArr = null;
		try {
			File file = new File(ConstantCaipiao.SHUANGSEQIU_LOCAL_PATH);
			...
			OutputStream fs = new FileOutputStream(ConstantCaipiao.getShuangSeQiuPath());
	...
	public static void main(String[] args) {
		ShuangSeQiuBase ShuangSeQiuBase = new ShuangSeQiuBase();
		ShuangSeQiuBase.makeXmlData();
